                ...
                <div className="max-w-[420px] w-full mx-auto my-auto py-8">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 py-2 px-3 rounded-lg border border-slate-200 hover:bg-slate-50 text-xs font-semibold text-slate-700 transition-colors shadow-2xs cursor-pointer"
                        >
