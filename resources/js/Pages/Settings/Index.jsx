        ...
        <>
            ...
            {modalManage && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
                    <div className="bg-white dark:bg-[#0e1d47] rounded-xl border border-slate-200/80 dark:border-[#1e346e] shadow-2xl w-full max-w-lg p-6 space-y-5 animate-in fade-in zoom-in-95 duration-150 my-8">
                        {/* Modal Header */}
                            ...
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-slate-400">
                                        Tersimpan langsung di database SQLite (tabel <code className="font-mono text-blue-500">integration_settings</code>)
                                    </p>
                                </div>
                            </div>
                            <button
