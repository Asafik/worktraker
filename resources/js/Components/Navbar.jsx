            ...
            <div className="flex items-center gap-2 sm:gap-4 pl-4">
                ...
                <div className="flex items-center gap-3 pl-1 cursor-pointer select-none group">
                    <img
                        src={userAvatar}
                        alt={userName}
                        className="w-9 h-9 rounded-full object-cover ring-2 ring-slate-100 dark:ring-slate-700 group-hover:ring-blue-400 transition-all"
                    />
                    <div className="hidden sm:block text-left">
                        ...
                        <span className="text-[11px] text-slate-400 dark:text-slate-400 font-normal">{userRole}</span>
                    </div>
                </div>
            </div>
        </header>
